...
CREATE TABLE `films_actors` (
  ...
  `name_actor` varchar(100) NOT NULL DEFAULT '',
  `surname_actor` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
...
CREATE TABLE `films_directors` (
  `id` int NOT NULL AUTO_INCREMENT,
  `film` varchar(100) NOT NULL DEFAULT '',
  `name_director` varchar(100) NOT NULL DEFAULT '',
  `surname_director` varchar(100) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-08-16  1:01:04
